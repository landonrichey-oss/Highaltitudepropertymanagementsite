      ...
      ${prop.reviews?.length ? `
        <div class="reviews-section">
          <div class="reviews-header">
            <h3>Guest Reviews</h3>
            ${prop.airbnbUrl ? `
              <a href="${prop.airbnbUrl}" target="_blank" rel="noopener" class="airbnb-link">
          ...
          ${prop.overallRating ? `
            <div class="overall-rating">
              <div class="rating-number">${prop.overallRating}</div>
              <div class="rating-details">
                <span class="review-count">${prop.reviewCount || ''} reviews</span>
                ${prop.airbnbUrl ? '<span class="source">on Airbnb</span>' : ''}
              </div>
            </div>
          ` : ''}
            ...
            ${prop.reviews.map(review => `
              <div class="review-card">
                <div class="reviewer-info">
                  <p class="reviewer-name">${review.name || "Guest"}</p>
